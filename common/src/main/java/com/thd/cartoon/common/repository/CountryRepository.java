...
public interface CountryRepository extends JpaRepository<Country,Long> {
    ...
    @Query(value = "select new com.thd.cartoon.common.dto.country.CountryDto(entity) " +
            "from Country entity where entity.voided <> true")
    List<CountryDto> getAll();

    @Query(value = "select new com.thd.cartoon.common.dto.country.CountryDto(entity) from Country entity " +
