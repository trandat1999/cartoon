package com.thd.cartoon.common.util.component;

import com.thd.cartoon.common.util.ConstUtil;
import com.thd.cartoon.common.util.anotation.LogActivity;
...
public class LogActivityAOP {
    @Around("@annotation(com.thd.cartoon.common.util.anotation.LogActivity)")
