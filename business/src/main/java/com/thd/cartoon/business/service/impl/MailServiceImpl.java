...
import com.thd.cartoon.common.exception.CartoonMovieException;
import com.thd.cartoon.common.repository.EmailNotificationRepository;
import com.thd.cartoon.common.repository.VerificationTokenRepository;
import com.thd.cartoon.business.service.MailService;
import com.thd.cartoon.common.type.TypeEmail;
...
public class MailServiceImpl extends BaseService implements MailService {
    ...
    public void sendMail(EmailNotification notificationEmail, Map<String, Object> data) {
        ...
        try {
            ...
            throw new CartoonMovieException(getMessage(SystemMessage.SEND_MAIL_ERROR, notificationEmail.getEmail()), e);
        }
    }
